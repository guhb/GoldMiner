var StartLayer = cc.Layer.extend({
    ...
    initMenu: function () {
        ...
        var newGame = cc.MenuItemSprite.create(startButton, startButtonSelected, startButtonDisabled, this, this.onNewGame);
        newGame.setPosition(cc.ccp(0, 0));
        var record = cc.MenuItemSprite.create(recordButton, recordButtonSelected, recordButtonDisabled, this, this.onRecord);
        record.setPosition(cc.ccp(150, 70));
        var about = cc.MenuItemSprite.create(aboutButton, aboutButtonSelected, aboutButtonDisabled, this, this.onAbout);
        about.setPosition(cc.ccp(280, 130));
        var menu = cc.Menu.create(newGame, record, about);
